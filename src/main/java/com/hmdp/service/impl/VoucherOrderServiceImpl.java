...
public class VoucherOrderServiceImpl extends ServiceImpl<VoucherOrderMapper, VoucherOrder> implements IVoucherOrderService {
    ...
    private static final ExecutorService SECKTLL_ORDER_EXECUTOR= Executors.newSingleThreadExecutor();
    ...
    private void hadnlePendingList() {
        while (true){
            try {
                ...
                //2.判断消息是否获取成功
                if (list==null||list.isEmpty()){
                    //2.1.如果获取失败，说明没有pending-list消息，结束循环
                    break;
                }
                //歇息消息中的订单信息
                MapRecord<String, Object, Object> record = list.get(0);
